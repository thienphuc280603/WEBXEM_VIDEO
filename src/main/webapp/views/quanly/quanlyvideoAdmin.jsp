		...
		<p style="font-size: 25px; margin-left: 20px; border-bottom: 1px solid rgb(195, 191, 191); width: 100%">THỐNG KÊ DỮ LIỆU</p>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <img src="${video!=null ?video.poster:'' }" alt="" width="100%"
                                style="margin-top: 30px;" id="imgPreview">
                        </div>
                        <div class="form-group col-md-8">
                            <div class="form-group">
                                <label for="">VIDEO TITLE?</label>
                                <input id="title" class="form-control" value="${video!=null ?video.title:'' }">
                            </div>
                            <div class="form-group">
                                <label for="">VIDEO HREF?</label>
                                <input id="href" class="form-control" value="${video!=null ?video.href:'' }">
                            </div>
							<div class="form-group">
                                <label for="">VIDEO DESCRIPTION?</label>
                                <input id="description" class="form-control" value="${video!=null ?video.description:'' }">
                            </div>
                            
                            <div class="form-group">
                                <label for="">VIDEO POSTER?</label>
                                <input id="poster" class="form-control" value="${video!=null ?video.poster:'' }">
                            </div>
                        </div>
                    </div>
...
$('#poster').change(function(){
	var newSrc = $('#poster').val(); // Sửa lại chỗ này
...
$('#submitBtn').click(function(){
	...
	$.ajax({
		url: '/PS24434_NguyenThienPhuc_ASMFinal/admin/video?action=add',
		type: 'POST',
		data: formData
	}).then(function(data){
		alert("xong");
