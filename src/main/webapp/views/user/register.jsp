...
<body>
            ...
            <div class="header_logo">
                ...
                <div class="header_login">
                    <ul>
                        ...
                        <li><a href="login" class="p_white">Đăng nhập</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container-md" style="min-height: 600px;">
        <p style="text-align: right; margin-top: 20px;">K+ Đăng kí</p>
        <div class="title" style="border-bottom: 1px solid rgb(150, 149, 149); width: 100%;">
            <span style="font-size: 20px;">ĐĂNG KÍ</span>
        </div>

        <center>
            <div class="form">
                <span
                    style="font-size: 25px; border-bottom: 1px solid rgb(150, 149, 149); margin-left: 70px; padding: 0 0 20px 0;">Đăng
                    kí
                    tài khoản</span>
                <form action="register" class="login" method="post">
                    ...
                    <input type="text" name="password" id="" placeholder="Password"
                        style="width: 350px; height: 35px; border-radius: 5px; border: 1px solid rgb(228, 227, 227);"><br>
                    <input type="text" name="email" id="" placeholder="EmailAddress"
                        style="width: 350px; height: 35px; border-radius: 5px; border: 1px solid rgb(228, 227, 227);"><br>
