...
<body>
    ...
    <div class="container-md" style="min-height: 600px;">
        ...
        <div class="title" style="border-bottom: 1px solid rgb(150, 149, 149); width: 100%;">
            <span style="font-size: 20px;">ĐỔI MẬT KHẨU</span>
        </div>
        ...
        <center>
            <div class="form">
                <span
                   ...
                   Quên mật khẩu</span>
                <form action="changePass" class="login" method="post">
                    <input type="text" name="currentPass" id="" placeholder="Mật khẩu hiện tại"
                        style="width: 350px; height: 35px; border-radius: 5px; border: 1px solid rgb(228, 227, 227);">
                    <input type="password" name="newPass" id="" placeholder="Mật khẩu mới"
